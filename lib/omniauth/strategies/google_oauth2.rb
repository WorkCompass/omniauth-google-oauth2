...
module OmniAuth
  module Strategies
    ...
    class GoogleOauth2 < OmniAuth::Strategies::OAuth2
      ROUTE_API_SCOPE_URL = '/auth/'
      BASE_SCOPES = %w[profile email openid].freeze
      DEFAULT_SCOPE = 'email,profile'
      ROUTE_API_USER_INFO_URL = '/oauth2/v3/userinfo'
      ROUTE_API_TOKEN_INFO_URL = '/oauth2/v3/tokeninfo'
      ...
      option :authorize_options, %i[access_type hd login_hint prompt request_visible_actions scope state redirect_uri include_granted_scopes openid_realm device_id device_name provider_api_url]
      ...
      option :client_options,
             ...
             base_auth_domain: 'accounts.google.com'
      ...
      extra do
        ...
        if !options[:skip_jwt] && !access_token['id_token'].nil?
          ...
          ::JWT::Verify.verify_claims(decoded,
                                      verify_iss: true,
                                      iss: [
                                        client.options[:base_auth_domain],
                                        'https://' + client.options[:base_auth_domain]
                                      ].freeze,
                                      verify_aud: true,
      ...
      def raw_info
        user_info_url = client.options[:base_api_url] + ROUTE_API_USER_INFO_URL
      ...
      def get_scope(params)
        ...
        base_scope_url = client.options[:base_api_url] + ROUTE_API_SCOPE_URL
      ...
      def verify_token(access_token)
        ...
        token_info_route = client.options[:base_api_url] + ROUTE_API_TOKEN_INFO_URL
        raw_response = client.request(:get, token_info_route,
